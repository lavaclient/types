 ...
 */
import type { TrackHash } from "../../rest/track.ts";
 ...
 *
 */
export declare const mayStartNext: Record<TrackEndReason, boolean>;
declare type Event<T extends PlayerEventType, D> = PlayerMessage<"event", {
    type: T;
} & D>;
/**
 ...
 */
export declare type TrackStartEvent = Event<"TrackStartEvent", TrackStartEventData>;
 ...
 *
 */
export declare type TrackEndEvent = Event<"TrackEndEvent", TrackEndEventData>;
 ...
 */
export declare type TrackStuckEvent = Event<"TrackStuckEvent", TrackStuckEventData>;
 ...
 */
export declare type TrackExceptionEvent = Event<"TrackExceptionEvent", TrackExceptionEventData>;
 ...
 */
export declare type WebSocketClosedEvent = Event<"WebSocketClosedEvent", WebSocketClosedEventData>;
...
export declare type PlayerUpdate = PlayerMessage<"playerUpdate", PlayerUpdateData>;
